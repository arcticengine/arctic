...
struct DataReader {
  ...
  /// @return The amount of data read (in floats)
  ...
  /// @return The amount of data read (in doubles)
  ...
  /// @return The amount of data read (in 64-bit unsigned integers)
  ...
  /// @return The amount of data read (in 32-bit unsigned integers)
  ...
  /// @return The amount of data read (in 16-bit unsigned integers)
  ...
  /// @return The amount of data read (in 8-bit unsigned integers)
